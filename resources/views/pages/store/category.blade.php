                    ...
                    <div class="row vertical-gap">
                        ...
                        <div class="col-md-6">
                            <div class="nk-product-cat">
                                ...
                                <div class="nk-product-cont">
                                    <h3 class="nk-product-title h5">
                                        <a href="store-product.html">Just then her head </a>
                                    </h3>
                                    <div class="nk-gap-1"></div>
                        ...
                        <div class="col-md-6">
                            <div class="nk-product-cat">
                                ...
                                <div class="nk-product-cont">
                                    <h3 class="nk-product-title h5">
                                        <a href="store-product.html">She was bouncing away</a>
                                    </h3>
                                    <div class="nk-gap-1"></div>
                        ...
                        <div class="col-md-6">
                            <div class="nk-product-cat">
                                ...
                                <div class="nk-product-cont">
                                    <h3 class="nk-product-title h5">
                                        <a href="store-product.html">The word was</a>
                                    </h3>
                                    <div class="nk-gap-1"></div>
                                    <div class="nk-product-rating" data-rating="5">
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-md-6">
                            <div class="nk-product-cat">
                                ...
                                <div class="nk-product-cont">
                                    <h3 class="nk-product-title h5">
                                        <a href="store-product.html">My mother was so much</a>
                                    </h3>
                                    <div class="nk-gap-1"></div>
                                    <div class="nk-product-rating" data-rating="3.5">
                                        <i class="fa fa-star"></i>

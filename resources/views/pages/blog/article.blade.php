                    ...
                    <div class="nk-blog-post nk-blog-post-single">
                        ...
                        <div class="nk-post-text mt-0">
                            <div class="nk-post-img">
                                <img src="/images/post-2.jpg" alt="Grab your sword and fight the Horde">
                            </div>
                            <div class="nk-gap-1"></div>
                            <h1 class="nk-post-title h4">Grab your sword and fight the Horde</h1>
                            <div class="nk-post-by">
                                <img src="/images/avatar-2.jpg" alt="Witch Murder" class="rounded-circle" width="35"> by <a href="#">Witch Murder</a> in Sep 5, 2018 <div class="nk-post-categories">
                            ...
                            <blockquote class="nk-blockquote">
                                ...
                                <div class="nk-blockquote-content"> Just then her head struck against the roof of the hall: in fact she was now more than nine feet high, and she at once took up the little golden key and hurried off to the garden door. As if she had known them all her life. Indeed, she had quite a long argument with the Lory. </div>
                                <div class="nk-blockquote-author">
                                    <span>Samuel Marlow</span>
                                </div>
                            </blockquote>
                            <div class="nk-gap"></div>
                            <img class="float-left mt-0" src="/images/post-inner-img.jpg" alt="">
                        ...
                        <h3 class="nk-decorated-h-2">
                            <span>
                                <span class="text-main-1">3</span> Comments </span>
                        </h3>
                        <div class="nk-gap"></div>
                        <div class="nk-comments">
                            ...
                            <div class="nk-comment">
                                <div class="nk-comment-meta">
                                    <img src="/images/avatar-2.jpg" alt="Witch Murder" class="rounded-circle" width="35"> by <a href="#">Witch Murder</a> in 20 September, 2018 <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 float-right">Reply</a>
                                </div>
                                ...
                                <div class="nk-comment">
                                    <div class="nk-comment-meta">
                                        <img src="/images/avatar-1.jpg" alt="Hitman" class="rounded-circle" width="35"> by <a href="#">Hitman</a> in 20 September, 2018 <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 float-right">Reply</a>
                                    </div>
                                    <div class="nk-comment-text">
                            ...
                            <div class="nk-comment">
                                <div class="nk-comment-meta">
                                    <img src="/images/avatar-3.jpg" alt="Wolfenstein" class="rounded-circle" width="35"> by <a href="#">Wolfenstein</a> in 21 September, 2018 <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 float-right">Reply</a>
                                </div>
                                <div class="nk-comment-text">
